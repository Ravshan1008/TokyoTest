...
public class ClearSkyeNewIdentityTest extends AppTest {
	...
	public void testMain(String dataFileKey) throws Exception{
		...
		Reporter.log("Testcase: Identity Creation Functionality");
		...
		super.logTestEnd();
		Reporter.log("Testcase:Verify Identity Creation functionality ended");
	}
